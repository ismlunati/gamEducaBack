...
INSERT INTO LOGROS_ARTEFACTOS(LOGRO_ID, ARTEFACTO_ID) VALUES(1, 1);

INSERT INTO RETO(ID, DESCRIPCION, NOMBRE, PUNTOS_OTORGADOS, ASIGNATURA_ID, LOGRO_ID, TEMA_ID, TEMPORAL, FECHAINICIO, FECHAFIN) VALUES (1, 'Reto', 'Reto', 100, 1, 1, 1, false, null, null);

INSERT INTO ALUMNOS_RETOS(ID, ESTADO, ALUMNO_ID, RETO_ID) VALUES (1, 'Finalizado', 1, 1);